import { mapSourceToValidated } from './address.mapper';
...
describe('mapSourceToValidated', () => {
  ...
  it('parses GeoJSON features[0].properties for US', () => {
    ...
    expect(mapped.zipCode).toBe('94103');
